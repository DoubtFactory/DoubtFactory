...
const toolbarConfig = [
    {
        name: "Text", items: [
            ...
            { label: "OL", action: "wrap", args: ["<ol>\n<li>", "</li>\n</ol>"] },
            { label: "UL", action: "wrap", args: ["<ul>\n<li>", "</li>\n</ul>"] },
            { label: "Indent", action: "insert", args: ["&nbsp;&nbsp;&nbsp;&nbsp;"] },
            { label: "Left", action: "wrap", args: ['<div style="text-align: left;">', "</div>"] },
            { label: "Center", action: "wrap", args: ['<div style="text-align: center;">', "</div>"] },
            { label: "Right", action: "wrap", args: ['<div style="text-align: right;">', "</div>"] },
            { label: "Justify", action: "wrap", args: ['<div style="text-align: justify;">', "</div>"] },
            { label: "HR", action: "insert", args: ["\n<hr>\n"] }
        ]
    },
    { name: "Arrows", items: ["→", "←", "⇌", "⇋", "⟶", "⟵", "↑", "↓"].map(s => ({ label: s, action: "insert", args: [s] })) },
    { name: "Charges", items: ["+", "−", "²⁺", "³⁺", "⁴⁺", "⁻", "²⁻", "³⁻", "⁴⁻", "δ+", "δ−"].map(s => ({ label: s, action: "insert", args: [s] })) },
    { name: "Subscripts", items: ["₀", "₁", "₂", "₃", "₄", "₅", "₆", "₇", "₈", "₉"].map(s => ({ label: s, action: "insert", args: [s] })) },
    { name: "Superscripts", items: ["⁰", "¹", "²", "³", "⁴", "⁵", "⁶", "⁷", "⁸", "⁹", "°", "′", "″"].map(s => ({ label: s, action: "insert", args: [s] })) },
    { name: "Greek", items: ["α", "β", "γ", "δ", "ε", "ζ", "η", "θ", "ι", "κ", "λ", "μ", "ν", "ξ", "π", "ρ", "σ", "τ", "φ", "χ", "ψ", "ω", "Ω"].map(s => ({ label: s, action: "insert", args: [s] })) },
    { name: "Common", items: ["Δ", "∇", "∞", "≈", "≠", "≤", "≥", "±", "×", "÷", "√", "∝", "∴", "∵", "⊕", "⊖", "⊗"].map(s => ({ label: s, action: "insert", args: [s] })) },
    { name: "Organic", items: ["CH₃", "CH₂", "CH", "COOH", "CHO", "COOR", "OH", "NH₂", "NO₂", "CN", "OR", "R", "Ar", "Ph", "Et", "Me", "Pr", "Bu", "t-Bu"].map(s => ({ label: s, action: "insert", args: [s] })) },
    { name: "Ions", items: ["H⁺", "OH⁻", "NH₄⁺", "NO₃⁻", "NO₂⁻", "SO₄²⁻", "SO₃²⁻", "HSO₄⁻", "CO₃²⁻", "HCO₃⁻", "PO₄³⁻", "HPO₄²⁻", "H₂PO₄⁻", "Cl⁻", "Br⁻", "I⁻", "F⁻", "CN⁻", "SCN⁻", "MnO₄⁻", "Cr₂O₇²⁻"].map(s => ({ label: s, action: "insert", args: [s] })) },
    { name: "Metals", items: ["Na⁺", "K⁺", "Li⁺", "Mg²⁺", "Ca²⁺", "Ba²⁺", "Sr²⁺", "Al³⁺", "Zn²⁺", "Fe²⁺", "Fe³⁺", "Cu⁺", "Cu²⁺", "Ag⁺", "Hg²⁺", "Pb²⁺", "Sn²⁺", "Sn⁴⁺"].map(s => ({ label: s, action: "insert", args: [s] })) },
    { name: "Gases", items: ["H₂", "O₂", "N₂", "F₂", "Cl₂", "Br₂", "I₂", "CO₂", "CO", "NO", "NO₂", "N₂O", "SO₂", "SO₃", "NH₃", "H₂S"].map(s => ({ label: s, action: "insert", args: [s] })) },
    { name: "Thermo", items: ["ΔH", "ΔS", "ΔG", "Ea", "Kc", "Kp", "Qc", "Qp", "Ka", "Kb", "Kw", "pH", "pOH"].map(s => ({ label: s, action: "insert", args: [s] })) },
    { name: "Math", items: ["θ", "π", "sin", "cos", "tan", "log", "ln", "e", "10⁻³", "10⁻⁶", "10⁻⁹"].map(s => ({ label: s, action: "insert", args: [s] })) },
    { name: "Bonds", items: ["—", "=", "≡", "··", ":", "•", "e⁻", "hν"].map(s => ({ label: s, action: "insert", args: [s] })) },
    { name: "Lab", items: ["Δ", "heat", "pressure", "catalyst", "aq", "l", "g", "s", "conc.", "dil."].map(s => ({ label: s, action: "insert", args: [s] })) },
    {
        name: "Templates", items: [
            { label: "Match the Column", action: "insert", args: ["<table border=\"0\" style=\"width:100%;\">\n<tbody>\n<tr><td>(A) </td><td>(p) </td></tr>\n<tr><td>(B) </td><td>(q) </td></tr>\n<tr><td>(C) </td><td>(r) </td></tr>\n<tr><td>(D) </td><td>(s) </td></tr>\n</tbody>\n</table>"] },
            { label: "Assertion Reason", action: "insert", args: ["<div><b>Assertion (A):</b> </div>\n<div><b>Reason (R):</b> </div>"] },
            { label: "Paragraph Question", action: "insert", args: ["<div><b>Paragraph:</b><p></p></div>"] },
            { label: "Integer Type", action: "insert", args: ["<b>Integer Answer:</b> "] },
            { label: "Chemical Equation", action: "insert", args: ["<div style=\"text-align: center;\">A + B → C + D</div>"] },
            { label: "Ionic Equation", action: "insert", args: ["<div style=\"text-align: center;\">A⁺ + B⁻ → AB</div>"] },
            { label: "Oxidation Number Table", action: "insert", args: ["<table border=\"1\" style=\"width:100%; text-align:center;\">\n<thead><tr><th>Species</th><th>Oxidation State</th></tr></thead>\n<tbody><tr><td></td><td></td></tr></tbody>\n</table>"] },
            { label: "Reaction Table", action: "insert", args: ["<table border=\"1\" style=\"width:100%; text-align:center;\">\n<thead><tr><th>Reactant</th><th>Reagent</th><th>Product</th></tr></thead>\n<tbody><tr><td></td><td></td><td></td></tr></tbody>\n</table>"] },
            { label: "3x3 Table", action: "insert", args: ["<table border=\"1\" style=\"width:100%; text-align:center;\">\n<tbody>\n<tr><td></td><td></td><td></td></tr>\n<tr><td></td><td></td><td></td></tr>\n<tr><td></td><td></td><td></td></tr>\n</tbody>\n</table>"] },
            { label: "4x4 Table", action: "insert", args: ["<table border=\"1\" style=\"width:100%; text-align:center;\">\n<tbody>\n<tr><td></td><td></td><td></td><td></td></tr>\n<tr><td></td><td></td><td></td><td></td></tr>\n<tr><td></td><td></td><td></td><td></td></tr>\n<tr><td></td><td></td><td></td><td></td></tr>\n</tbody>\n</table>"] }
        ]
    }
];
...
function buildToolbar(textarea) {
    ...
    textarea.addEventListener("input", () => {
        // Debounce history saving for manual typing
...
document.querySelectorAll(".chem-editor").forEach(textarea => {
...
function setSavingState(isSaving) {
    ...
    if (isSaving) {
        ...
        saveButton.textContent = isEditing ? "Update Question" : "Save Question";
    }
}
...
async function updateDashboard() {
    ...
    if (subjectCount) subjectCount.textContent = uniqueSubjects.length;

    const chapterCount = document.getElementById("chapterCount");
    if (chapterCount) chapterCount.textContent = uniqueChapters.length;

    const examCount = document.getElementById("examCount");
    if (examCount) examCount.textContent = uniqueExams.length;

    const totalVideosEl = document.getElementById("totalVideos");
    if (totalVideosEl) totalVideosEl.textContent = totalVideos;

    const commentCount = document.getElementById("commentCount");
    if (commentCount) commentCount.textContent = questions.length > 0 ? Math.max(1, Math.round(questions.length / 3)) : 0;
...
function renderRecentActivity(questions) {
    ...
    const recent = [...questions].reverse().slice(0, 4);
    ...
    container.innerHTML = recent.map(question => {
        ...
        const qText = question.question ? question.question.replace(/<[^>]*>?/gm, '').slice(0, 70) : "Untitled question";
        return `
